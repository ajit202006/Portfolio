    ...
    return (
        <div className='bg-[#050616] w-full h-full xl:w-4/5 xl:h-4/5 flex flex-col justify-around pt-4 items-center lg:rounded-4xl lg:shadow-[0px_0px_56px_5px_rgba(255,255,255,0.25)]'>
            ...
            <div className='w-full h-9/10 flex flex-col gap-y-7 md:flex-row justify-around items-center overflow-y-auto [&::-webkit-scrollbar]:hidden'>
                ...
                <form className='w-4/5 md:w-2/5 h-full flex flex-col items-center justify-center gap-y-2 text-xl' action=''>
                    <h3 className='text-2xl font-bold mb-2'>Message me here :</h3>
                    <label htmlFor='name'>Your Name :</label>
                    <input className='bg-slate-500 py-1 px-1 rounded-lg w-4/5' type='text' id='name' placeholder='Enter your name...' />
                    <label htmlFor='e-mail'>Your Email :</label>
                    <input className='bg-slate-500 py-1 px-1 rounded-lg w-4/5' type='email' id='e-mail' placeholder='Enter your email...' />
                    <label htmlFor='message'>Your message :</label>
                    <textarea className='resize-none bg-slate-500 py-1 px-1 rounded-lg w-4/5' id='message' placeholder='Enter your message...'></textarea>
                    <input className='bg-slate-700 hover:bg-slate-600 active:bg-slate-900 py-1 px-1.5 rounded-full' type='submit' />
                </form>
            </div>
        </div>
    )
