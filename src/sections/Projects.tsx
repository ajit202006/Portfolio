    ...
    return (
        <div className='bg-[#050616] w-full h-full xl:w-4/5 xl:h-4/5 flex flex-col justify-around pt-4 items-center lg:rounded-4xl lg:shadow-[0px_0px_56px_5px_rgba(255,255,255,0.25)]'>
            ...
            <div className='w-full md:w-3/5 h-9/10 flex flex-wrap gap-x-[calc(25%)] gap-y-7 justify-center items-center overflow-y-scroll [&::-webkit-scrollbar]:hidden *:shadow-[0px_0px_7px_4px_rgba(255,255,255,0.25)]'>
                <div className='grid place-items-center w-4/5 md:w-48 h-48 rounded-xl'>
                ...
                <div className='grid place-items-center w-4/5 md:w-48 h-48 rounded-xl'>
                    <img className="w-full h-full object-cover rounded-xl object-left blur-sm" src={visualClockImg} alt="Visual Clock Image" />
                ...
                <div className='grid place-items-center w-4/5 md:w-48 h-48 rounded-xl'>
                    <img className="w-full h-full object-cover rounded-xl object-left blur-sm" src={todoAppImg} alt="Todo App Image" />
                ...
                <div className='grid place-items-center w-4/5 md:w-48 h-48 rounded-xl'>
                    <img className="w-full h-full object-cover rounded-xl object-left blur-sm" src={quizAppImg} alt="TicTacToe Image" />
